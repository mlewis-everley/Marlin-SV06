 ...
 */
    ...
    static_assert(DEFAULT_EJERK >= 5, "It is strongly recommended to set DEFAULT_EJERK >= 5 when using LIN_ADVANCE. Enable ALLOW_LOW_EJERK to bypass this alert (e.g., for direct drive).");
  #endif
#endif
